...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* title */}
      <div className='absolute right-auto top-1/2 left-1/2 -translate-x-1/2 md:translate-x-0 -translate-y-1/2 md:translate-y-0 md:left-auto md:top-5 md:right-5 tracking-widest text-7xl md:text-8xl text-neutral-600 text-center md:text-right font-chakra font-semibold'>
        <motion.div
          initial='off'
          animate='on'
      ...
      {/* text */}
      <div className='absolute top-5 md:top-auto bottom-auto md:bottom-5 md:left-5 text-white/90 w-3/4 text-left md:text-left md:pb-0 px-5 md:px-0 md:w-1/3 text-sm md:text-base'>
      ...
      {/* realização */}
      <motion.div
        className='absolute right-5 bottom-5 text-white/50 text-base md:text-lg tracking-wider font-chakra -translate-y-[55px] md:translate-y-0'
        initial='off'
        animate='on'
