...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* text */}
      <div className='absolute top-5 md:top-auto bottom-auto md:bottom-5 md:left-5 text-white/80 w-3/4 text-left md:text-left md:pb-0 px-5 md:px-0 md:w-1/3 text-sm md:text-base'>
