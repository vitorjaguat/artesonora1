...
export default function FirstThreePrograms({ firstThree }) {
  ...
  return (
    <div className='absolute w-full top-10 left-14'>
      <div className='w-1/2 flex flex-col gap-4'>
        <div className='-mb-2 w-full text-center tracking-[4px]'>
        ...
        <div className='flex  gap-2 text-white/90'>
          {firstThree.map((post, index) => (
            ...
            >
              ...
              {/* title */}
              <div
                className='py-2 w-full flex justify-center items-center text-center text-sm px-4 bg-neutral-300/80 h-full text-black/80'
