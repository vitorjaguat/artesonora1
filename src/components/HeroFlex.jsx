...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className='absolute inset-0 w-screen md:w-[calc(100vw-52px)] h-[calc(100vh-109px)] md:h-[calc(100vh-92px)] p-5 pb flex flex-col justify-between'>
        {/* title */}
        <div className='w-full flex-1 flex pt-40 md:pt-0 justify-center md:justify-end tracking-widest text-7xl md:text-8xl text-neutral-700 text-center md:text-right font-chakra font-semibold'>
          {' '}
          <motion.div
            initial='off'
            animate='on'
        ...
        <div className='md:h-full  w-full flex-1 flex flex-col md:flex-row justify-between md:items-end gap-6 pb-[75px] md:pb-0'>
          {/* text */}
          <div className=' text-white/80 w-3/4 text-left md:text-left md:pb-0  md:w-1/3 text-base'>
            ...
            <span className='font-bold'>Saulo Laudares</span>, com formatos,
            como cursos, residências, exposições, happenings, programas de
            rádio, publicações etc. Neste site você encontrará materiais que
            documentam os 15 anos desta prática.
          </div>

          <motion.div
            className=' text-white/80 text-base md:text-lg tracking-wider font-chakra flex md:block justify-end items-end'
            initial='off'
            animate='on'
      ...
      {/* text */}
      {/* <div className='absolute bottom-5 md:left-5 text-white/80 w-3/4 text-left md:text-left md:pb-0 px-5 md:px-0 md:w-1/3 text-base -translate-y-[10px] md:translate-y-0'>
          ...
          publicações etc. Neste site você encontrará materiais que documentam
          os 15 anos desta prática.
        </div> */}
